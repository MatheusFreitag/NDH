class PessoasController < ApplicationController
  ...
  private
    ...
    def pessoa_params
      params.require(:pessoa).permit(:nome, :sobrenome, :estadoCivil, :nacionalidade, :endereco, :genero, :idade, :profissao, :beneficio, :alfabetizado, :numeroCarteiraDeTrabalho, :referenciaProcesso)
    end
end
